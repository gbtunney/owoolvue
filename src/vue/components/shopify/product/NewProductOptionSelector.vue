...
//    import Multiselect from '@/components/utilities/gMultiselectList.vue'
    ...
    export default {
        ...
        console.log("selected variant is ", this.$data.selectedVariant);
	        ///SelectedVariant
        ...
        methods: {
            ...
            getSwatchSrc:function (option){
                ...
                if (newFilteredArray.length>=1 ) {
                    ...
                    var img = this.product_image_dictionary.get( String(variant.image_id))
                    console.log("AERT CLLUNG ",this.product_image_dictionary);



                }
                        return false//ShopifyImgURL(img.src,'100x100') ;
            ...
            _getVariantFromOptions: function() {
                ...
                if (arrayAfterFilter.length == 1){
                    ...
                    if (arrayAfterFilter[0] != this.SelectedVariant){
	                    ...
	                    console.log(" VARIANT THAT MEET CRITERIA FOUND ", this.$data.selectedOptions,this.SelectedVariant)
